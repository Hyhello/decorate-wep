...
<script>
    ...
    import { getHardPackageList } from '@/api/product';
    ...
    export default {
        ...
        methods: {
            async _getList () {
                this.loading = true;
                const result = await getHardPackageList(this.searchData);
                this.loading = false;
                this.list = result.data.dataList;
                this.total = result.data.total;
            },
            detail (id) {
                this.$router.push({path: '/product/detail', query: {id, from: 'hardPackage', name: this.$route.meta.title}});
            }
        }
    };
</script>
